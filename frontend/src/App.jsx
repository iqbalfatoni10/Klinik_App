  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/dashboard" element={<PrivateRoute element={<DasboardPasien />} requiredRole="patient" />}>
        ...
        <Route path="/dashboard-dokter" element={<PrivateRoute element={<DokterSidebar />} requiredRole="doctor" />}>
